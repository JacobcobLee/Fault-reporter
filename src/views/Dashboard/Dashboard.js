...
function getcasestodayChart(){
  axios
  .get("https://bchfrserver.herokuapp.com/api/v1/casestodaychart")
  .then((response) => {
...
function getcasesytdChart(){
  axios
  .get("https://bchfrserver.herokuapp.com/api/v1/casesyesterdaychart")
  .then((response) => {
...
function getcasesthedaybeforeytdChart(){
  axios
  .get("https://bchfrserver.herokuapp.com/api/v1/casesthedaybeforeytdchart")
  .then((response) => {
...
function getcomplimentChart(){
  axios
  .get("https://bchfrserver.herokuapp.com/api/v1/feedbackcomplimentchart")
  .then((response) => {
...
function getcomplaintChart(){
  axios
  .get("https://bchfrserver.herokuapp.com/api/v1/feedbackcomplaintchart")
  .then((response) => {
    //console.log(response.data);
